...
const customMenuSchemas = [
  ...
  },
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": "What is the Customized Menu at JIP Caterers?", "acceptedAnswer": { "@type": "Answer", "text": "The Customized Menu allows you to build a completely tailored catering package for both Veg and Non-Veg preferences. Choose from Normal, Elite, or Premium menu tiers as a base and customize specific dishes, add live counters, adjust portions, and add special items to match your guest preferences and budget." } },
...
function CustomMenu() {
  ...
  return (
    <div className="relative">
      ...
      <FAQ faqs={[
        { question: "Can I completely customize the catering menu with JIP Caterers?", answer: "Yes! JIP Caterers offers full menu customization for both Veg and Non-Veg preferences. You can start from a base tier (Normal, Elite, or Premium) and add, remove, or swap any items to perfectly match your preferences, dietary restrictions, and event theme." },
        { question: "What are the base menu tiers I can start from for customization?", answer: "You can choose from three starting points — Normal Menu (traditional banana leaf), Elite Menu (premium variety with welcome drinks), or Premium Menu (luxury with live counters and full spread) — all available in Pure Veg and Non-Veg — and then customize from there." },
        ...
        { question: "How do I communicate my custom menu requirements to JIP Caterers?", answer: "Simply select your preferred base menu on this page, choose Veg or Non-Veg preference, list any additional custom requirements in the text box, and submit. Our team will reach out via WhatsApp or phone to confirm and finalise the details." },
        ...
        { question: "Can I request a specific theme-based menu for my event?", answer: "Yes. We can curate a theme-based menu — traditional Chettinad spread, Kongu-style feast, festival-special dishes, or a mixed Veg and Non-Veg spread. Speak with our team to explore the options available." },
