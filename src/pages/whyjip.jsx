...
function WhyJip() {
  ...
  return (
    <div className="relative">
      ...
      <FAQ faqs={[
        { question: "Why should I choose JIP Caterers over other caterers in Tiruvallur?", answer: "JIP Caterers stands apart through decades of heritage cooking, authentic banana leaf service, strict hygiene protocols, professionally uniformed serving staff, and a consistent track record of grand feasts that guests remember for a lifetime. We now serve both Pure Veg and Non-Veg menus." },
        { question: "Do JIP Caterers use traditional cooking methods and recipes?", answer: "Yes. Our master cooks use traditional recipes passed down through generations, cooking in pure brass and steel vessels with hand-picked regional spices to preserve authentic South Indian flavours — for both Veg and Non-Veg dishes." },
        ...
        { question: "Are the ingredients sourced fresh and locally?", answer: "Yes. We source fresh, locally available vegetables and non-veg ingredients daily. Farm-fresh produce and high-quality meat cooked with traditional methods ensures your guests experience authentic South Indian flavours in every bite." },
